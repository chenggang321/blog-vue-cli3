  ...
  <div v-if="compileContent">
    <div class="blog-card" style="margin-top: 20px;">
      ...
      <p style="font-size: 10px;">
        ...
        ><span class="glyphicon glyphicon-eye-open blog-icon" /><span>({{ content.meta.views }})</span></span>&nbsp;
        <span
          class="blog-tag blog-tag&#45;&#45;danger"
        ><span class="glyphicon glyphicon-comment blog-icon" /><span>({{ content.meta.comments }})</span></span>
      </p>

...
+(function(a) {
  ...
  if ((b[0] < 2 && b[1] < 9) || (b[0] == 1 && b[1] == 9 && b[2] < 1)) {
    throw new Error(
...
+(function(a) {
  ...
  function b(b) {
    return this.each(function() {
      ...
      var f = a.extend({}, c.DEFAULTS, d.data(), typeof b === 'object' && b)
      var g = typeof b === 'string' ? b : f.slide
  ...
  (c.prototype.slide = function(b, d) {
    ...
    var f = d || this.getItemForDirection(b, e)
    var g = this.interval
    var h = b == 'next' ? 'left' : 'right'
    var i = this
...
+(function(a) {
  ...
  function c(b) {
    return this.each(function() {
      ...
      var f = a.extend({}, d.DEFAULTS, c.data(), typeof b === 'object' && b)
...
+(function(a) {
  ...
  function b(b, d) {
    return this.each(function() {
      ...
      var g = a.extend({}, c.DEFAULTS, e.data(), typeof b === 'object' && b)
  ...
  (c.prototype.show = function(b) {
    var d = this
    var e = a.Event('show.bs.modal', { relatedTarget: b })
...
+(function(a) {
  ...
  (b.prototype.process = function() {
    ...
    var d = this.options.offset + c - this.$scrollElement.height()
    var e = this.offsets
    var f = this.targets
...
+(function(a) {
  ...
  (c.prototype.show = function() {
    ...
    if (
      ...
      var f = a.Event('hide.bs.tab', { relatedTarget: b[0] })
      var g = a.Event('show.bs.tab', { relatedTarget: e[0] })
      if (
        (e.trigger(f),
        b.trigger(g),
...
+(function(a) {
  ...
  (c.prototype.getState = function(a, b, c, d) {
    ...
    if (c != null && this.affixed == 'top') return c > e ? 'top' : !1
